<%-- 
    Document   : userHome
    Created on : Mar 11, 2016, 1:49:44 AM
    Author     : dell-lap
--%>
...
%>
    ...
    <center>
           <marquee> <h2><u>Welcome <font color="red"> <%=u%></font></u></h2></marquee>
                <br>
                <font background="silver">
                <h3>
                    <ul>
                        <li><a href="MakeComplaint.jsp"><h3>Complaints</h3></a></li>   <br>

                        <li><a href="techsoln.jsp"><h3><font color="24px">Technical Solution</h3></a></li><br>
                        
                        <li><a href="download.jsp"><h3>Software Download</h3></a></li>
                    </ul>
               </h3> 
                </font>
