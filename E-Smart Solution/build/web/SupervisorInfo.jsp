<%-- 
    Document   : SupervisorInfo
    Created on : Mar 11, 2016, 1:41:11 AM
    Author     : dell-lap
--%>
...
<tr style="background-color: burlywood">
            ...
            <td><a href="SupUpdate.jsp?par=<%=rst.getString("username")%>"><font color="yellow">Edit</font></a></td>
        </tr>
...
%>    
         ...
         <a href="AddSup.jsp"><input type="submit" value="Add Supervisor" /></a> 
