<%-- 
    Document   : completed
    Created on : Mar 11, 2016, 1:44:41 AM
    Author     : dell-lap
--%>
                ...
                <div class="container">
                    ...
                    <nav class="col-8 menu mob-menu pull-right">
                       ...
                       <!-- <div class="menu-item-box center "><a href="#" class="menu_link">Home</a>
                        ...
                        <div class="menu-item-box center "> <li><a href="Logout.jsp"><span>Logout</span></a></li>
...
String idd=(String)request.getParameter("par");
int id=Integer.parseInt(idd);
ResultSet rst1=stm.executeQuery("select * from complaintsassigned where complaintId='"+id+"'");
%>
...
%>
        <tbody>
            <tr>
                <td>Complaint Id</td>
                <td><input type="text" name="cid" value='<%=rst1.getInt("complaintId") %>' readonly="readonly" /></td>
            </tr>
            <tr>
                <td>Customer Username</td>
                <td><input type="text" name="cuser" value='<%=rst1.getString("custUsername") %>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Problem Type</td>
                <td><input type="text" name="pt" value='<%=rst1.getString("prob_type") %>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Problem Desc.</td>
                <td><input type="text" name="pd" size="60" value='<%=rst1.getString("prob_desc") %>' readonly="readonly" /></td>
            </tr>
...
%>
    ...
    <input type="submit" value="Confirm Completed!" />
