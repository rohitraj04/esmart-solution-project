<%-- 
    Document   : SupUpdate
    Created on : Mar 11, 2016, 1:40:06 AM
    Author     : dell-lap
--%>
...
String u1=request.getParameter("par");
ResultSet rst=stm.executeQuery("select * from supervisor where username='"+u1+"'");

%>
<form action="SupUpdate" method="POST">
    <%
if(rst.next())
{       
%>
    ...
    <tbody>
        <tr>
            <td>Supervisor ID</td>
            <td><input type="text" name="id" value='<%=rst.getInt("sup_id")%>' readonly="readonly" /></td>
        </tr>
        <tr>
