<%-- 
    Document   : techsoln
    Created on : Mar 11, 2016, 1:50:13 AM
    Author     : dell-lap
--%>
...
%>
         <tr style="background-color: yellowgreen">
             <td><%=rst1.getInt("cid")%></td>
             <td><%=rst1.getString("cuser") %></td>
             <td><%=rst1.getString("pt") %></td>
             <td><%=rst1.getString("pd") %></td>
             <td><%=rst1.getString("solution") %></td>
