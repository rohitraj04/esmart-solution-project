<%-- 
    Document   : EngineerInfo
    Created on : Mar 11, 2016, 1:38:05 AM
    Author     : dell-lap
--%>
...
<tr style="background-color: yellowgreen">
            ...
            <td><a href="EnggUpdate.jsp?par1=<%=rst.getString("username")%>"><font color="black">Edit</font></a></td>
            <td><a href="solve.jsp?par1=<%=rst.getString("username")%>"><font color="black">Solve</font></a></td>
        </tr>
...
<br>
     <div class="gadget">
          ...
          <a href="AddEngg.jsp"><input type="submit" value="Add Engineer" /></a>   
