<%-- 
    Document   : engineerHome
    Created on : Mar 11, 2016, 1:46:07 AM
    Author     : dell-lap
--%>
...
%>
    ...
    <center>
          <h2><u>Welcome <%=u%></u></h2>
                ...
                <h3>
                    <ul>
                        <li><a href="myAssignment.jsp">My Assignments</a></li><br>
                        <li><a href="completedAssgnmt.jsp">Completed Assignments</a></li><br>
