<%-- 
    Document   : AddSup
    Created on : Mar 11, 2016, 1:25:35 AM
    Author     : dell-lap
--%>
...
<%@page import="java.sql.*,mysqlC.conn" %>  
    <jsp:useBean id="form" class="org.timtroy.bean.MyForm2" scope="request">  
    ...
    <%  
            ...
            if (form.process()) {  
                ...
                ResultSet rst=stm.executeQuery("select * from supervisor");
                if(rst.next())
                {
                id=rst.getInt(1);
                }
                id++;
               stm.executeUpdate("insert into supervisor values('"+id+"','"+p+"','"+n+"','"+a+"','"+c+"','"+sal+"','"+e+"','"+u+"','"+ar+"')");
...
<body>
    ...
    <center>
        <h2><u>Supervisor Registration</u></h2>
                <br>
...
<%!  
        ...
        public void jspInit() {  
            errorMap.put(MyForm2.ERR_NAME_BLANK, "Please enter name");  
            errorMap.put(MyForm2.ERR_ADD_BLANK, "Please enter address");  
            errorMap.put(MyForm2.ERR_CONTACT_BLANK, "Please enter mobile no.");  
            errorMap.put(MyForm2.ERR_CONTACT_LENGTH, "Contact should be 10 digit");  
            errorMap.put(MyForm2.ERR_CONTACT_INVALID, "Invalid contact no.");

           errorMap.put(MyForm2.ERR_EMAIL_BLANK, "Please enter email id");  
            errorMap.put(MyForm2.ERR_EMAIL_INVALID, "Please enter valid email id");  
            errorMap.put(MyForm2.ERR_USER_BLANK, "Please enter username");  
            errorMap.put(MyForm2.ERR_USER_EXISTS, "Username already exists");  
            errorMap.put(MyForm2.ERR_PASS_BLANK, "Please enter password"); 
            errorMap.put(MyForm2.ERR_PASS_LENGTH, "Length should be 5 or more");  
            errorMap.put(MyForm2.ERR_PASS_MATCH, "Password does not match");  
            errorMap.put(MyForm2.ERR_SALARY_BLANK, "Please enter the salary");  
            errorMap.put(MyForm2.ERR_SALARY_INVALID, "Invalid salary");  
