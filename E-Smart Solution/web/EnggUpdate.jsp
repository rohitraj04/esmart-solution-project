<%-- 
    Document   : EnggUpdate
    Created on : Mar 11, 2016, 1:37:19 AM
    Author     : dell-lap
--%>
...
String u=(String)hs.getAttribute("aUser");   
if(u==null)
   {
...
String u1=request.getParameter("par1");
ResultSet rst=stm.executeQuery("select * from engineer where username='"+u1+"'");

%>
<form action="EnggUpdate" method="POST">
    <%
if(rst.next())
{       
%>
    ...
    <tbody>
        <tr>
            <td>Engg. ID</td>
            <td><input type="text" name="id" value='<%=rst.getInt("emp_id")%>' readonly="readonly" /></td>
        </tr>
        <tr>
            <td>Engg. Username</td>
            <td><input type="text" name="user" value='<%=rst.getString("username")%>' readonly="readonly" /></td>
        </tr>
        <tr>
            <td>Engg. Password</td>
            <td><input type="text" name="pass" value='<%=rst.getString("password")%>' /></td>
        </tr>
        <tr>
            <td>Engg. Name</td>
        ...
        <tr>
            <td>Address</td>
            <td><input type="text" name="add" value='<%=rst.getString("address")%>' /></td>
        </tr>
        <tr>
            <td>Contact</td>
            <td><input type="text" name="contact" value='<%=rst.getString("contact")%>' /></td>
        </tr>
        <tr>
            <td>Area</td>
            <td><input type="text" name="area" value='<%=rst.getString("area")%>' readonly="readonly" /></td>
        </tr>
        <tr>
            <td>Email ID</td>
            <td><input type="text" name="email" value='<%=rst.getString("email")%>' /></td>
        </tr>
        <tr>
            <td>Salary</td>
            <td><input type="text" name="salary" value='<%=rst.getString("salary")%>' /></td>
        </tr>
    </tbody>
</table>
<%
