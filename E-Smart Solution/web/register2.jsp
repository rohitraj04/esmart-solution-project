<%-- 
    Document   : register2
    Created on : Mar 11, 2016, 12:45:59 AM
    Author     : dell-lap
--%>
...
<body>
    ...
    <center>
        <br>
            <h6><u>  <div class="main-title font-color-m-grey ">You are Registered Now !!</div></u></h6> 
               
               <br>
                   <br>
                Check your email. You are provided with 4 digit verification code which will be asked one time only<br>
                on logging in.
