<%-- 
    Document   : asgndcomp
    Created on : Mar 11, 2016, 1:44:13 AM
    Author     : dell-lap
--%>
...
if(rst1.next())
       {
id=rst1.getInt("sup_id");
}

rst2=stm.executeQuery("select * from complaintsassigned where SupId='"+id+"'");
%>
...
%>
        <tr style="background-color: yellowgreen">
            ...
            <td><%=rst2.getString("custUsername") %></td>
            <td><%=rst2.getString("address") %></td>
            <td><%=rst2.getString("area") %></td>
            <td><%=rst2.getInt("EnggId") %></td>
