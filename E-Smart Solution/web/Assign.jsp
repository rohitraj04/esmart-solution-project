<%-- 
    Document   : Assign
    Created on : Mar 11, 2016, 1:28:35 AM
    Author     : dell-lap
--%>
...
%>
    ...
    <center>
        <%
          String area="";
          String par1=request.getParameter("par");
conn ob=new conn();          
Connection con=ob.c();
Statement stm=con.createStatement();
ResultSet rst1,rst2,rst3;
rst1=stm.executeQuery("select * from supervisor where username='"+u+"'");
if(rst1.next())
       {
area=rst1.getString("area");
}
rst1.close();
rst2=stm.executeQuery("select * from complaints where complaint_id='"+par1+"'");
...
%>
            <tr>
                <td>Complaint ID</td>
                <td><input type="text" name="cid" value='<%=rst2.getInt("complaint_id")%>' readonly="readonly" /></td>
            </tr>
            <tr>
                <td>User</td>
                <td><input type="text" name="user" value='<%=rst2.getString("user")%>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Problem Type</td>
                <td><input type="text" name="pt" value='<%=rst2.getString("prob_type")%>' readonly="readonly" /></td>
            </tr>
            <tr>
                <td>Problem Desc.</td>
                <td><input type="text" name="pd" value='<%=rst2.getString("prob_desc")%>' size="60" readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Area</td>
                <td><input type="text" name="area" value='<%=rst2.getString("area")%>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Contact</td>
                <td><input type="text" name="contact" value='<%=rst2.getString("contact")%>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Address</td>
                <td><input type="text" name="add" value='<%=rst2.getString("address")%>' readonly="readonly"/></td>
            </tr>
            <tr>
                <td>Complaint Time</td>
                <td><input type="text" name="ct" value='<%=rst2.getString("c_time")%>' readonly="readonly"/></td>
            </tr>
            <%
} 
rst3=stm.executeQuery("select * from engineer where area='"+area+"'"); 
%>
            <tr>
                <td>Engineer Id</td>
                <td><select name="eId">
...
<option><%=rst3.getInt("emp_id")%></option>
                         <%
}            
%>
                    </select></td>
