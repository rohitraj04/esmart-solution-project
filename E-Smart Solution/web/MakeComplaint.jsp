<%-- 
    Document   : MakeComplaint
    Created on : Mar 11, 2016, 1:40:33 AM
    Author     : dell-lap
--%>
...
<link rel="stylesheet" href="https://twitter.com/thinking_virus?family=quickweb-icon-twitter" >
    ...
    <script type="text/javascript">
        ...
        function validation()
        {
            ...
            var x=document.forms["comp"]["pd"].value;
            if(x==null || x=="")
                {
                    
                    alert("Enter the problem description");
                    return false;
                }
                            ...
                            if(x.toString().length<20)
                                {
                                    ...
                                    alert("Description should be more than 20 letters");
                                    return false;
                                }
        }
</SCRIPT>
...
%>
    ...
    <center>
         <h2><u>Welcome <%=u%></u></h2>
                ...
                <form action="MakeComplaint" method="POST" name="comp" onsubmit="return validation()">
                    ...
                    <table border="0">
                        <tbody>
                            <tr>
                                <td>Problem Type</td>
                                <td><select name="pt">
                                        <option>OS Troubleshooting</option>
                                        <option>OS Installation</option>
                                        <option>Hardware Troubleshooting</option>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="pd" value="" size="60" /></td>
                            </tr>
                        </tbody>
                    </table>
